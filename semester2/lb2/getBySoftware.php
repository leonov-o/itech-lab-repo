...
<table>
    ...
    echo "let prev = JSON.parse(localStorage.getItem('bySoftware'));";
    echo "localStorage.setItem('bySoftware', JSON.stringify([computersData]));";
    echo "if(prev) localStorage.setItem('bySoftware', JSON.stringify([...prev, computersData]));";
    echo "</script>";
    ?>
...
<div id="recent">
    ...
    <script>
        const recentQueries = JSON.parse(localStorage.getItem('bySoftware'));
