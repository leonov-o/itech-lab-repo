...
<table>
    ...
    foreach ($computers as $computer) {
        if (date("Y") > $computer->purchaseYear + $computer->warrantyPeriod) {
            $filtered[] = $computer;
    ...
    echo "let prev = JSON.parse(localStorage.getItem('byWarranty'));";
    echo "localStorage.setItem('byWarranty', JSON.stringify([computersData]));";
    echo "if(prev) localStorage.setItem('byWarranty', JSON.stringify([...prev, computersData]));";
    echo "</script>";
    ?>
...
<div id="recent">
    ...
    <script>
        const recentQueries = JSON.parse(localStorage.getItem('byWarranty'));
